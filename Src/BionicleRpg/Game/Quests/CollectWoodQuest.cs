...
// Type: GameManager.Quests.CollectWoodQuest
...
namespace GameManager.Quests
{
  public class CollectWoodQuest : Quest
  {
    ...
    public CollectWoodQuest(Matoran questGiver, int amount)
      : base(questGiver)
    {
      this.toGet = amount;
      Tree.OnResourceGathered += new EventHandler(this.OnCollectedResource);
      this.Name = "Collect " + this.toGet.ToString() + " wood";
    }
