...
// Type: GameManager.Quests.CollectBambooQuest
...
{
  public class CollectBambooQuest : Quest
  {
    private int toGet;
    ...
    public CollectBambooQuest(Matoran questGiver, int amount)
      : base(questGiver)
    {
      this.toGet = amount;
      Bamboo.OnResourceGathered += new EventHandler(this.OnCollectedResource);
      this.Name = "Collect " + this.toGet.ToString() + " bamboo";
    }
